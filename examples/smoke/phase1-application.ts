...
export interface PhaseOneMetrics {
  ...
  readonly visualEvidence: PhaseOneVisualEvidence;
}

export interface PhaseOneColorCounts {
  readonly cameraOnly: number;
  readonly forbiddenCameraOnly: number;
  readonly shared: number;
}

export interface PhaseOneVisualEvidence {
  readonly compositeGap: readonly [number, number, number, number];
  readonly follow: PhaseOneColorCounts;
  readonly isolated: boolean;
  readonly overview: PhaseOneColorCounts;
}

export interface PhaseOneResizeEvidence {
...
export interface PhaseOneApplication {
  readonly app: Application;
  readonly metrics: PhaseOneMetrics;
  destroy(): void;
  resize(
    width: number,
    height: number,
...
export async function createPhaseOneApplication(
  host: HTMLElement,
): Promise<PhaseOneApplication> {
  ...
  const followCounts: PhaseOneColorCounts = {
  ...
  const overviewCounts: PhaseOneColorCounts = {
  ...
  const visualEvidence: PhaseOneVisualEvidence = {
    compositeGap,
    follow: followCounts,
    isolated:
