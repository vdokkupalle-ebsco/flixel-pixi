...
class PlayState extends FlxState {
  ...
  override create(): void {
    ...
    const ballGraphic = FlxGraphic.fromPixels(ballPixels, 'replay-ball');
    ...
    const markerGraphic = FlxGraphic.fromPixels(markerPixels, 'replay-marker');
...
export async function bootReplayDemo(
  host?: HTMLElement | null,
): Promise<ReplayApplication> {
