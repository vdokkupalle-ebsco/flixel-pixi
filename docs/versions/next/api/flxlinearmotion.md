---
title: FlxLinearMotion (Class)
description: API reference documentation for FlxLinearMotion in Flixel-Pixi.
editLink: false
---
...
```ts
export declare class FlxLinearMotion extends FlxMotion
```
