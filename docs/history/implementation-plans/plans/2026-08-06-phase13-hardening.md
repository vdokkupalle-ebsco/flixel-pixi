...
- Date: YYYY-MM-DD
- Spec: [`2026-08-06-phase13-hardening-design.md`](../specs/2026-08-06-phase13-hardening-design.md)
...
```markdown
Status: **hardening pass in progress** (2026-08-06). Atlas sprite FPS baseline + short soak shipped; full C13 (30‑minute soak, hard budgets, 1.0 publish) not closed. See [`hardening.md`](../../porting/hardening.md) and [`2026-08-06-phase13-hardening-design.md`](../specs/2026-08-06-phase13-hardening-design.md).
```
