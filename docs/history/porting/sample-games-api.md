...
- [`mode-lite-gap.md`](mode-lite-gap.md) — compatibility-exercise gaps and the outstanding external-port requirement
...
- **Playwright** (`tests/browser/sample-games.spec.ts`): **12/12 passed** (4 scenarios × Chromium, Firefox, WebKit)
