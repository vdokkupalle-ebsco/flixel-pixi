...
| Modern HaxeFlixel virtual controls        | Adapted        | Texture-free HUD D-pad/action buttons publish serializable virtual-button and virtual-axis sources through the deterministic action/replay pipeline, with native semantic buttons for keyboard and screen-reader access. Analog sticks remain deferred. |
